...
//==================================================================
// TBD: Add indexing for point coord P.x[i] (but save P[] for Point arrays)
...
public:
    ...
    //----------------------------------------------------------
    // Point and Vector Joint Operations (always valid)
...
extern pga::Point P_0;  // the "0" Point (0,0,0)

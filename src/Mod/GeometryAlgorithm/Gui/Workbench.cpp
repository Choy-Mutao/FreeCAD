...
using namespace GeometryAlgorithmGui;

/// @namespace GeometryAlgorithmGui @class Workbench
TYPESYSTEM_SOURCE(GeometryAlgorithmGui::Workbench, Gui::StdWorkbench)
...
Gui::ToolBarItem* Workbench::setupToolBars() const
{
    ...
    test->setCommand("GeometryAlgorithm Tools");
